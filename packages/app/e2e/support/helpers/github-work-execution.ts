...
import type { prepareGithubWorkRun } from "./github-work-journey";
import { assertGithubWorkChecklist } from "./github-work-checklist";
import {
  openAssignmentRunForReview,
  openTeamRunAgentForReview,
  openTeamRunChangesForReview,
  teamRunReviewDetail,
} from "./team-run-review";
import {
  GITHUB_WORK_PROOF_FILE,
  GITHUB_WORK_PROOF_MODEL,
  type startGithubWorkProof,
} from "./github-work-proof";

// Browser and Electron share the same paid execution and evidence assertions.
// The caller owns host setup, renderer-specific reload, and resource cleanup.
export async function executeGithubWorkRun(
  page: Page,
  proof: Awaited<ReturnType<typeof startGithubWorkProof>>,
  testInfo: TestInfo,
  { assignment, workspace }: Awaited<ReturnType<typeof prepareGithubWorkRun>>,
