...
export const ar: TranslationResources = {
  ...
  githubWork: {
    ...
    hostOffline: "بانتظار اتصال هذا المضيف",
    updateHost: "حدّث هذا المضيف لتصفح عمل GitHub",
    site: "اسم مضيف GitHub",
    invalidSite: "أدخل اسم مضيف دون رابط أو مسار",
    repositories: "المستودعات",
    searchRepositories: "البحث في المستودعات",
    searchWork: "البحث في المسائل وطلبات السحب",
    selectRepository: "اختر مستودعًا",
    noRepositories: "لم يتم العثور على مستودعات",
    noWork: "لا يوجد عمل مطابق",
    issues: "المسائل",
    ...
    all: "الكل",
    archived: "مؤرشف",
    loadFailed: "تعذّر تحميل عمل GitHub",
    openSource: "فتح في GitHub",
    openFailed: "تعذّر فتح GitHub",
    updateAssignments: "حدّث هذا المضيف لإنشاء تكليفات",
    invalidWorkItem: "لا يمكن حفظ هذا العنصر كعنصر عمل",
    noBody: "لا يوجد وصف",
    bodyTruncated: "تم اختصار المعاينة. افتح GitHub لعرض الوصف الكامل.",
    loadMore: "تحميل المزيد",
    refresh: "تحديث",
  },
  assignments: {
  ...
  teams: {
    ...
    title: "الفرق",
    newTeam: "فريق جديد",
    selectTeam: "اختر فريقًا لعرض الأدوار وسير العمل",
    noHosts: "أضف مضيفًا لإدارة الفرق",
    emptyHost: "لا توجد فرق على هذا المضيف",
    openTeam: "فتح {{name}} على {{host}}",
    roleStepCount: "{{roles}} أدوار · {{steps}} خطوات",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "جارٍ الاتصال",
      loading: "جارٍ التحميل",
      ready: "متصل",
      unsupported: "يلزم التحديث",
      offline: "غير متصل",
      error: "خطأ",
      unsupportedDetail: "يجب تحديث هذا المضيف قبل إدارة الفرق.",
      profilesUnsupported: "حدّث هذا المضيف لإنشاء الفرق أو تعديلها باستخدام ملفات تعريف الوكلاء.",
      readOnlyOffline: "هذا الفريق للقراءة فقط حتى يتصل مضيفه.",
    },
    actions: {
      ...en.teams.actions,
      create: "إنشاء فريق",
      ...
      manageProfiles: "إدارة ملفات تعريف الوكلاء",
      retry: "إعادة المحاولة",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "تعليمات الفريق",
      roles: "الأدوار",
      workflow: "سير العمل",
      missingProfile: "ملف تعريف الوكيل مفقود",
      missingRole: "الدور مفقود",
      noStepInstructions: "لا توجد تعليمات خاصة بهذه الخطوة",
    },
    runs: {
      ...en.teams.runs,
      actions: {
      ...
      form: {
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "يجب أن يستخدم كل دور خاضع للإشراف ملف تعريف وكيل يعطّل التفويض الأصلي للمزوّد.",
        },
      },
      supervision: {
        ...
        progress: "اكتملت {{completed}} من {{total}} من عناصر العمل",
        needsReview: "يحتاج إلى مراجعة",
        reviewRequest: "طلب مراجعة",
        loadingRequest: "جارٍ تحميل تفاصيل الطلب…",
        updateRequired: "حدّث هذا المضيف لفحص نشاط الإشراف والرد عليه.",
        offline: "اتصل بهذا المضيف لتحميل تفاصيل الإشراف.",
        activity: "نشاط الإشراف",
        emptyActivity: "لم يُسجّل أي نشاط إشراف حتى الآن.",
        status: {
          queued: "في قائمة الانتظار",
          planning: "التخطيط",
          working: "جارٍ العمل",
          awaiting_human: "بانتظار المراجعة",
          completed: "مكتمل",
          failed: "فشل",
          canceled: "ملغى",
          interrupted: "متوقف",
        ...
        permission: {
          title: "يلزم إذن المزوّد",
          detail: "ينتظر {{role}} في مخطط الوكيل الزمني.",
        ...
        response: {
          ...
          submit: "إرسال الرد",
          conflict: "تغيّر هذا الطلب على المضيف. راجع أحدث طلب وحاول مرة أخرى.",
          validation: {
            action_required: "اختر إجراءً.",
            action_unavailable: "لم يعد الإجراء المحدد متاحًا.",
            note_required: "يتطلب هذا الإجراء ملاحظة.",
            note_too_long: "يجب ألا تتجاوز الملاحظات 4,096 حرفًا.",
            request_settled: "تمت تسوية هذا الطلب بالفعل.",
          },
        },
      },
    },
    form: {
      ...
      host: "المضيف",
      selectHost: "اختر مضيفًا",
      noHosts: "لا توجد مضيفات مؤهلة",
      name: "الاسم",
      instructions: "تعليمات الفريق",
      roleName: "اسم الدور",
      profile: "ملف تعريف الوكيل",
      selectProfile: "اختر ملف تعريف وكيل",
      noProfiles: "لا توجد ملفات تعريف وكلاء",
      searchProfiles: "البحث في ملفات تعريف الوكلاء",
      roleInstructions: "تعليمات الدور",
      workflowRole: "الدور",
      selectRole: "اختر دورًا",
      noRoles: "لا توجد أدوار",
      unnamedRole: "دور بلا اسم",
      stepInstructions: "تعليمات الخطوة",
      optional: "اختياري",
    },
    delete: {
      title: "حذف الفريق؟",
      message: "هل تريد حذف {{name}}؟ ستبقى عمليات تشغيل الفريق السابقة دون تغيير.",
    },
    errors: {
      load: "تعذر تحميل الفرق",
      conflict: "تغيّر هذا الفريق على المضيف. أغلق المحرر وأعد تحميله ثم حاول مرة أخرى.",
    },
  },
  operations: {
    title: "العمليات",
  ...
  settings: {
    ...
    host: {
      ...
      agentProfiles: {
        ...
        securityBoundaryLabel: "حد الأمان",
        securityBoundaryPlaceholder: "اختر حد أمان يوفّره المزود",
        noSecurityBoundaries: "لا يوفّر هذا المزود حدود أمان مدعومة",
        customSecurityBoundary: "إعدادات أصلية مخصصة",
        securityStates: {
          idle: "اختر مزودًا لفحص حدود الأمان المدعومة.",
          pending: "جارٍ فحص حدود الأمان التي يدعمها المزود…",
          available: "يوفّر المزود هذا الحد ويتحقق منه.",
          unrecognized: "يحتوي ملف التعريف على إعدادات أصلية مخصصة. ستُحفظ حتى تختار حدًا مدعومًا.",
          stale: "تغيّرت عناصر تحكم الأمان لدى المزود. أعد اختيار الحد قبل الحفظ.",
          read_only: "ستُحفظ إعدادات الأمان الأصلية الحالية، لكن لا يمكن تعديلها هنا.",
          unavailable: "تعذر تحميل حدود الأمان. أعد محاولة جلب لقطة المزوّد.",
          unsupported: "لا يعلن هذا المزود عن حدود أمان قابلة للتعديل.",
          update_required: "حدّث هذا المضيف قبل تغيير ملف تعريف يحتوي على إعدادات أمان أصلية.",
        },
