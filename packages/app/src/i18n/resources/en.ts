export const en = {
  ...
  githubWork: {
    ...
    hostOffline: "Waiting for this host to connect",
    updateHost: "Update this host to browse GitHub work",
    site: "GitHub hostname",
    invalidSite: "Enter a hostname without a URL or path",
    repositories: "Repositories",
    searchRepositories: "Search repositories",
    searchWork: "Search issues and pull requests",
    selectRepository: "Select a repository",
    noRepositories: "No repositories found",
    noWork: "No matching work",
    issues: "Issues",
    ...
    all: "All",
    archived: "Archived",
    loadFailed: "Unable to load GitHub work",
    openSource: "Open in GitHub",
    openFailed: "Unable to open GitHub",
    updateAssignments: "Update this host to create Assignments",
    invalidWorkItem: "This item cannot be saved as a Work Item",
    noBody: "No description",
    bodyTruncated: "Preview truncated. Open GitHub for the full description.",
    loadMore: "Load more",
    refresh: "Refresh",
  },
  assignments: {
    ...
    noHosts: "Add a host to manage Assignments",
    emptyHost: "No Assignments on this host",
    openAssignment: "Open {{title}} on {{host}}",
    noWorkItem: "No linked Work Item",
    hostStates: {
      connecting: "Connecting",
      loading: "Loading",
      ready: "Online",
      ...
      offline: "Offline",
      error: "Error",
      unsupportedDetail: "This host needs an update before it can manage Assignments.",
      readOnlyOffline: "This Assignment is read-only until its host is online.",
    },
    status: {
      open: "Open",
      completed: "Completed",
    ...
    detail: {
      ...
      objective: "Objective",
      workItem: "Work Item reference",
      openWorkItem: "Open Work Item {{identifier}}",
      runs: "Team Runs",
      artifacts: "Artifacts",
    },
    form: {
      ...
      host: "Host",
      selectHost: "Select a host",
      noHosts: "No eligible hosts",
      title: "Title",
      titlePlaceholder: "Ship the next release",
      objective: "Objective",
      objectivePlaceholder: "Describe the durable outcome this work should produce",
      workItem: "Work Item reference",
      revisionRecovered:
        "This Assignment changed on the host. Your input is preserved against the latest revision.",
      validation: {
        host_required: "Select a host.",
        title_required: "Enter an Assignment title.",
        title_too_long: "Assignment titles must be 120 characters or fewer.",
        objective_required: "Enter an Objective.",
        objective_too_long: "Objectives must be 32,000 characters or fewer.",
        work_item_invalid: "Choose a valid Work Item reference.",
      },
    },
    workItem: {
      pickerTitle: "Choose Work Item",
      source: "Source",
      selectSource: "Select a source",
      noSources: "No Work Item sources on this host",
      search: "Search Work Items",
      searchPlaceholder: "Search by title or identifier",
      noResults: "No matching Work Items",
      searching: "Searching...",
      remove: "Remove Work Item reference",
      none: "No Work Item is linked. Assignments do not mirror tracker content.",
      replace: "Replace Work Item",
      choose: "Choose Work Item",
    },
    runs: {
      selectTeam: "Select a Team",
      chooseTeam: "Choose {{name}}",
      noTeams: "No eligible Teams on this host",
      empty: "No Team Runs for this Assignment yet",
      offline: "Connect to this host to load Team Run history.",
      open: "Open run for {{team}}",
    },
    artifacts: {
      empty: "No explicit Artifacts have been recorded for this Assignment.",
      offline: "Connect to this host to load Artifacts.",
      bytes: "{{included}} of {{original}} bytes",
      truncated: "Truncated",
      complete: "Complete",
      producer: "Assignment revision {{revision}} · run {{run}} · agent {{agent}}",
      legacy: "This legacy objective-only Team Run has no explicit Artifacts.",
    },
    complete: {
      title: "Complete Assignment?",
      message: "Mark {{title}} complete? Its frozen run and Artifact history will remain.",
    },
    cancel: {
      title: "Cancel Assignment?",
      message: "Cancel {{title}}? Its frozen run and Artifact history will remain.",
    },
    errors: {
      load: "Could not load Assignments",
      notFound: "This Assignment was not found on the selected host.",
      hostMissing: "This Assignment's host is no longer configured.",
      hostOffline: "Connect to this host to load the Assignment.",
      conflict: "This Assignment changed on the host. Reload it and try again.",
      conflictRecovered:
        "The Assignment changed on the host. Review your preserved input and save again.",
      activeRun: "Wait for the active Team Run to finish or cancel it first.",
    },
  },
  teams: {
    title: "Teams",
    newTeam: "New Team",
    selectTeam: "Select a Team to view its roles and workflow",
    noHosts: "Add a host to manage Teams",
    emptyHost: "No Teams on this host",
    openTeam: "Open {{name}} on {{host}}",
    roleStepCount: "{{roles}} roles · {{steps}} steps",
    hostStates: {
      connecting: "Connecting",
      loading: "Loading",
      ready: "Online",
      ...
      offline: "Offline",
      error: "Error",
      unsupportedDetail: "This host needs an update before it can manage Teams.",
      profilesUnsupported: "Update this host to create or edit Teams with Agent Profiles.",
      readOnlyOffline: "This Team is read-only until its host is online.",
    },
    actions: {
      create: "Create Team",
      edit: "Edit",
    ...
    detail: {
      sharedInstructions: "Team instructions",
      roles: "Roles",
      workflow: "Workflow",
      missingProfile: "Missing Agent Profile",
      missingRole: "Missing role",
      noStepInstructions: "No step-specific instructions",
    },
    runs: {
      actions: {
        runTeam: "Run Team",
      ...
      profileStates: {
        ...
        profile_ambiguous: "Duplicate profile ID",
        profile_invalid: "Profile invalid",
        provider_unavailable: "Provider unavailable",
        model_unavailable: "Model unavailable",
        mode_unavailable: "Mode unavailable",
        thinking_unavailable: "Thinking unavailable",
      ...
      form: {
        ...
        noWorkspaces: "No active Workspaces on this host",
        objective: "Objective",
        objectivePlaceholder: "Describe the outcome this Team should produce",
        execution: "Execution",
        executionModes: {
        ...
        validation: {
          ...
          supervisor_required: "Select a supervisor role.",
          supervisor_unavailable:
            "This Team needs a role outside the worker workflow before it can run under supervision.",
          native_delegation_unenforced:
            "Every supervised role must use an Agent Profile that disables provider-native delegation.",
        },
      },
      supervision: {
        title: "Supervision",
        supervisor: "Supervisor: {{name}}",
        progress: "{{completed}} of {{total}} Work Items completed",
        needsReview: "Needs review",
        reviewRequest: "Review request",
        loadingRequest: "Loading request details…",
        updateRequired: "Update this host to inspect and respond to supervision activity.",
        offline: "Connect to this host to load supervision details.",
        activity: "Supervision activity",
        emptyActivity: "No supervision activity has been recorded yet.",
        status: {
          queued: "Queued",
          planning: "Planning",
          working: "Working",
        ...
        permission: {
          title: "Provider permission needed",
          detail: "{{role}} is waiting in its agent timeline.",
          openAgent: "Open agent",
        },
        references: {
          decision: "Decision",
        ...
        response: {
          ...
          conflict: "This request changed on the host. Review the latest request and try again.",
          validation: {
            action_required: "Choose an action.",
            action_unavailable: "The selected action is no longer available.",
            note_required: "This action requires a note.",
            note_too_long: "Notes must be 4,096 characters or fewer.",
            request_settled: "This request has already been resolved.",
          },
        },
      },
      recent: {
      ...
      detail: {
        title: "Team Run",
        revision: "Team revision {{revision}}",
        objective: "Objective",
        workspace: "Workspace",
      ...
      cancel: {
        ...
        message: "Stop the active work for {{name}}? Later roles will not start.",
      },
      errors: {
        notFound: "This Team Run was not found on the selected host.",
        hostOffline: "Connect to this host to load the Team Run.",
      },
    },
    form: {
      ...
      noHosts: "No eligible hosts",
      name: "Name",
      namePlaceholder: "Delivery Team",
      instructions: "Team instructions",
      instructionsHint: "Shared context applied to every role.",
      instructionsPlaceholder: "Describe the Team's goal and shared constraints",
      roleNumber: "Role {{number}}",
      roleName: "Role name",
      roleNamePlaceholder: "Planner",
      profile: "Agent Profile",
      selectProfile: "Select an Agent Profile",
      noProfiles: "No Agent Profiles",
      searchProfiles: "Search Agent Profiles",
      roleInstructions: "Role instructions",
      roleInstructionsHint: "Owned by this Team, separate from the Agent Profile.",
      roleInstructionsPlaceholder: "Describe this role's responsibility",
      ...
      stepInstructionsPlaceholder: "Add instructions specific to this handoff",
      optional: "Optional",
      validation: {
        host_required: "Select a host.",
        profiles_loading: "Agent Profiles are loading.",
        name_required: "Enter a Team name.",
        name_too_long: "Team names must be 120 characters or fewer.",
        instructions_required: "Enter Team instructions.",
        instructions_too_long: "Team instructions must be 32,000 characters or fewer.",
        role_required: "Add at least one role.",
        too_many_roles: "Add no more than 12 roles.",
        role_name_required: "Every role needs a name.",
        role_name_too_long: "Role names must be 80 characters or fewer.",
        role_instructions_required: "Every role needs instructions.",
        role_instructions_too_long: "Role instructions must be 32,000 characters or fewer.",
        role_profile_required: "Select an Agent Profile for every role.",
        role_profile_too_long: "The selected Agent Profile ID is too long.",
        role_profile_missing: "Repair roles whose Agent Profile is missing.",
        workflow_required: "Add at least one workflow step.",
        too_many_steps: "Add no more than 24 workflow steps.",
        step_instructions_too_long: "Step instructions must be 32,000 characters or fewer.",
        workflow_role_required: "Every workflow step needs a role.",
      },
    },
    delete: {
      title: "Delete Team?",
      message: "Delete {{name}}? Historical Team Runs will remain unchanged.",
    },
    errors: {
      load: "Could not load Teams",
      conflict: "This Team changed on the host. Close the editor, reload it, and try again.",
    },
  },
  operations: {
    title: "Operations",
