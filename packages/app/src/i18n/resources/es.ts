...
export const es: TranslationResources = {
  ...
  visual: {
    ...
    relationship: {
      nested: "Hijo de {{parent}}",
      provider: "Subagente del proveedor de {{parent}}",
    },
    availability: {
  ...
  githubWork: {
    ...
    hostOffline: "Esperando la conexión de este host",
    updateHost: "Actualiza este host para explorar trabajo de GitHub",
    site: "Nombre de host de GitHub",
    invalidSite: "Introduce un nombre de host sin URL ni ruta",
    repositories: "Repositorios",
    searchRepositories: "Buscar repositorios",
    searchWork: "Buscar incidencias y solicitudes de incorporación",
    selectRepository: "Selecciona un repositorio",
    noRepositories: "No se encontraron repositorios",
    noWork: "No hay trabajo coincidente",
    issues: "Incidencias",
    ...
    all: "Todas",
    archived: "Archivado",
    loadFailed: "No se pudo cargar el trabajo de GitHub",
    openSource: "Abrir en GitHub",
    openFailed: "No se pudo abrir GitHub",
    updateAssignments: "Actualiza este host para crear asignaciones",
    invalidWorkItem: "Este elemento no se puede guardar como elemento de trabajo",
    noBody: "Sin descripción",
    bodyTruncated: "Vista previa truncada. Abre GitHub para ver la descripción completa.",
    loadMore: "Cargar más",
    refresh: "Actualizar",
  },
  assignments: {
  ...
  teams: {
    ...
    selectTeam: "Selecciona un equipo para ver sus roles y flujo de trabajo",
    noHosts: "Añade un host para gestionar equipos",
    emptyHost: "No hay equipos en este host",
    openTeam: "Abrir {{name}} en {{host}}",
    roleStepCount: "{{roles}} roles · {{steps}} pasos",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "Conectando",
      loading: "Cargando",
      ...
      error: "Error",
      unsupportedDetail: "Este host debe actualizarse para gestionar equipos.",
      profilesUnsupported:
        "Actualiza este host para crear o editar equipos con perfiles de agente.",
      readOnlyOffline: "Este equipo será de solo lectura hasta que el host esté en línea.",
    },
    actions: {
      ...en.teams.actions,
      create: "Crear equipo",
      ...
      moveUp: "Subir",
      moveDown: "Bajar",
      manageProfiles: "Gestionar perfiles de agente",
      retry: "Intentar de nuevo",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "Instrucciones del equipo",
      roles: "Roles",
      workflow: "Flujo de trabajo",
      missingProfile: "Falta el perfil de agente",
      missingRole: "Falta el rol",
      noStepInstructions: "Sin instrucciones específicas para este paso",
    },
    runs: {
      ...en.teams.runs,
      actions: {
      ...
      detail: {
        ...
        reviewChangesHint:
          "Estos son los cambios actuales del espacio de trabajo y pueden incluir trabajo posterior. Los artefactos de la ejecución permanecen inmutables.",
      },
      form: {
        ...en.teams.runs.form,
        execution: "Ejecución",
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "Cada rol supervisado debe usar un perfil de agente que desactive la delegación nativa del proveedor.",
        },
      },
      supervision: {
        ...
        progress: "{{completed}} de {{total}} elementos de trabajo completados",
        needsReview: "Necesita revisión",
        reviewRequest: "Solicitud de revisión",
        loadingRequest: "Cargando detalles de la solicitud…",
        updateRequired:
          "Actualiza este host para consultar y responder a la actividad de supervisión.",
        offline: "Conéctate a este host para cargar los detalles de supervisión.",
        activity: "Actividad de supervisión",
        emptyActivity: "Aún no se ha registrado actividad de supervisión.",
        status: {
          queued: "En cola",
          planning: "Planificando",
          working: "Trabajando",
          awaiting_human: "Esperando revisión",
        ...
        permission: {
          title: "Se necesita permiso del proveedor",
          detail: "{{role}} está esperando en la cronología de su agente.",
        ...
        response: {
          ...
          conflict:
            "Esta solicitud cambió en el host. Revisa la solicitud más reciente e inténtalo de nuevo.",
          validation: {
            action_required: "Elige una acción.",
            action_unavailable: "La acción seleccionada ya no está disponible.",
            note_required: "Esta acción requiere una nota.",
            note_too_long: "Las notas deben tener 4.096 caracteres o menos.",
            request_settled: "Esta solicitud ya se ha resuelto.",
          },
        },
      },
    },
    form: {
      ...
      name: "Nombre",
      instructions: "Instrucciones del equipo",
      roleName: "Nombre del rol",
      profile: "Perfil de agente",
      selectProfile: "Selecciona un perfil de agente",
      noProfiles: "No hay perfiles de agente",
      searchProfiles: "Buscar perfiles de agente",
      roleInstructions: "Instrucciones del rol",
      workflowRole: "Rol",
      selectRole: "Selecciona un rol",
      noRoles: "No hay roles",
      unnamedRole: "Rol sin nombre",
      stepInstructions: "Instrucciones del paso",
      optional: "Opcional",
    },
    delete: {
      title: "¿Eliminar equipo?",
      message: "¿Eliminar {{name}}? Las ejecuciones históricas del equipo no cambiarán.",
    },
    errors: {
      load: "No se pudieron cargar los equipos",
      conflict:
        "Este equipo cambió en el host. Cierra el editor, vuelve a cargarlo e inténtalo de nuevo.",
    },
  },
  operations: {
    title: "Operaciones",
    ...
    actions: {
      ...
      openWorkspace: "Abrir espacio de trabajo {{workspace}}",
    },
    summary: {
      working: "Trabajando",
      attention: "Atención",
      idle: "Inactivo",
      accessibility: "Trabajando {{working}}, atención {{attention}}, inactivo {{idle}}",
    },
    states: {
      running: "Trabajando",
    ...
    relationship: {
      ...
      missing: "El agente padre {{parent}} no está disponible",
      cycle: "Relación padre no válida",
    },
  },
  agentList: {
