...
export const fr: TranslationResources = {
  ...
  githubWork: {
    ...
    hostOffline: "En attente de connexion de cet hôte",
    updateHost: "Mettez cet hôte à jour pour parcourir le travail GitHub",
    site: "Nom d’hôte GitHub",
    invalidSite: "Saisissez un nom d’hôte sans URL ni chemin",
    repositories: "Dépôts",
    searchRepositories: "Rechercher des dépôts",
    searchWork: "Rechercher des tickets et des demandes de fusion",
    selectRepository: "Sélectionner un dépôt",
    noRepositories: "Aucun dépôt trouvé",
    noWork: "Aucun travail correspondant",
    issues: "Tickets",
    ...
    all: "Tous",
    archived: "Archivé",
    loadFailed: "Impossible de charger le travail GitHub",
    openSource: "Ouvrir dans GitHub",
    openFailed: "Impossible d’ouvrir GitHub",
    updateAssignments: "Mettez cet hôte à jour pour créer des affectations",
    invalidWorkItem: "Cet élément ne peut pas être enregistré comme élément de travail",
    noBody: "Aucune description",
    bodyTruncated: "Aperçu tronqué. Ouvrez GitHub pour voir la description complète.",
    loadMore: "Charger plus",
    refresh: "Actualiser",
  },
  assignments: {
  ...
  teams: {
    ...
    selectTeam: "Sélectionnez une équipe pour voir ses rôles et son flux de travail",
    noHosts: "Ajoutez un hôte pour gérer les équipes",
    emptyHost: "Aucune équipe sur cet hôte",
    openTeam: "Ouvrir {{name}} sur {{host}}",
    roleStepCount: "{{roles}} rôles · {{steps}} étapes",
    hostStates: {
      ...en.teams.hostStates,
      ...
      offline: "Hors ligne",
      error: "Erreur",
      unsupportedDetail: "Cet hôte doit être mis à jour pour gérer les équipes.",
      profilesUnsupported:
        "Mettez cet hôte à jour pour créer ou modifier des équipes avec des profils d’agent.",
      readOnlyOffline: "Cette équipe est en lecture seule tant que son hôte est hors ligne.",
    },
    actions: {
      ...en.teams.actions,
      ...
      moveUp: "Monter",
      moveDown: "Descendre",
      manageProfiles: "Gérer les profils d’agent",
      retry: "Réessayer",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "Instructions de l’équipe",
      roles: "Rôles",
      workflow: "Flux de travail",
      missingProfile: "Profil d’agent manquant",
      missingRole: "Rôle manquant",
      noStepInstructions: "Aucune instruction propre à cette étape",
    },
    runs: {
      ...en.teams.runs,
      actions: {
      ...
      form: {
        ...
        selectSupervisor: "Sélectionnez un rôle de superviseur",
        noSupervisors: "Ajoutez un rôle d’équipe absent du flux de travail",
        approvalFingerprint: "Empreinte d’approbation",
        approvalFingerprintDescription:
          "Identifie l’espace de travail et la configuration de lancement exacts que le daemon vérifiera de nouveau au démarrage.",
        validation: {
          ...en.teams.runs.form.validation,
          workspaces_loading: "Chargement des espaces de travail.",
          supervisor_required: "Sélectionnez un rôle de superviseur.",
          supervisor_unavailable:
            "Cette équipe a besoin d’un rôle hors du flux de travail pour être exécutée sous supervision.",
          native_delegation_unenforced:
            "Chaque rôle supervisé doit utiliser un profil d’agent qui désactive la délégation native du fournisseur.",
        },
      },
      supervision: {
        ...en.teams.runs.supervision,
        title: "Supervision",
        supervisor: "Superviseur : {{name}}",
        progress: "{{completed}} éléments de travail terminés sur {{total}}",
        needsReview: "Révision requise",
        reviewRequest: "Demande de révision",
        loadingRequest: "Chargement des détails de la demande…",
        updateRequired:
          "Mettez cet hôte à jour pour consulter l’activité de supervision et y répondre.",
        offline: "Connectez-vous à cet hôte pour charger les détails de supervision.",
        activity: "Activité de supervision",
        emptyActivity: "Aucune activité de supervision n’a encore été enregistrée.",
        status: {
          queued: "En attente",
          planning: "Planification",
          working: "En cours",
          awaiting_human: "En attente de révision",
          completed: "Terminée",
          failed: "Échec",
          canceled: "Annulée",
        ...
        permission: {
          title: "Autorisation du fournisseur requise",
          detail: "{{role}} attend dans la chronologie de son agent.",
        ...
        response: {
          ...
          action: "Action",
          selectAction: "Choisissez une action",
          noActions: "Aucune action disponible",
          note: "Note",
          optionalNote: "Note (facultative)",
          submit: "Envoyer la réponse",
          conflict:
            "Cette demande a changé sur l’hôte. Consultez la dernière demande et réessayez.",
          validation: {
            action_required: "Choisissez une action.",
            action_unavailable: "L’action sélectionnée n’est plus disponible.",
            note_required: "Cette action nécessite une note.",
            note_too_long: "Les notes doivent contenir au maximum 4 096 caractères.",
            request_settled: "Cette demande a déjà été résolue.",
          },
        },
      },
    },
    form: {
      ...
      name: "Nom",
      instructions: "Instructions de l’équipe",
      roleName: "Nom du rôle",
      profile: "Profil d’agent",
      selectProfile: "Sélectionnez un profil d’agent",
      noProfiles: "Aucun profil d’agent",
      searchProfiles: "Rechercher des profils d’agent",
      roleInstructions: "Instructions du rôle",
      workflowRole: "Rôle",
      selectRole: "Sélectionnez un rôle",
      noRoles: "Aucun rôle",
      unnamedRole: "Rôle sans nom",
      stepInstructions: "Instructions de l’étape",
      optional: "Facultatif",
    },
    delete: {
      title: "Supprimer l’équipe ?",
      message: "Supprimer {{name}} ? Les exécutions historiques de l’équipe resteront inchangées.",
    },
    errors: {
      load: "Impossible de charger les équipes",
      conflict: "Cette équipe a changé sur l’hôte. Fermez l’éditeur, rechargez-la et réessayez.",
    },
  },
  operations: {
    title: "Opérations",
    ...
    untitledProviderSubagent: "Sous-agent fournisseur sans titre",
    providerSubagent: "Sous-agent fournisseur",
    ...
    availability: {
      ...
      refreshFailed: "Impossible d’actualiser les Opérations",
      hostDataLastKnown:
        "Impossible d’actualiser les données de {{host}} ; affichage des dernières données connues",
      hostDataUnavailable: "Impossible de charger les données de {{host}}",
      ...
      providerSubagentsPartial: "Certaines données de sous-agents fournisseur sont indisponibles",
      providerSubagentsUnsupported:
        "{{host}} doit être mis à jour pour afficher les sous-agents fournisseur",
      providerSubagentsLastKnown:
        "Les sous-agents de {{host}} n’ont pas pu être actualisés ; affichage des dernières données connues",
      providerSubagentsUnavailable: "Les sous-agents de {{host}} n’ont pas pu être chargés",
    },
    relationship: {
