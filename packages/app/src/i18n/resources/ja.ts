...
export const ja: TranslationResources = {
  ...
  githubWork: {
    ...
    host: "ホスト",
    selectHost: "ホストを選択",
    noHosts: "設定済みのホストがありません",
    hostOffline: "このホストの接続を待っています",
    updateHost: "GitHub の作業を閲覧するにはホストを更新してください",
    site: "GitHub ホスト名",
    invalidSite: "URL やパスを含まないホスト名を入力してください",
    repositories: "リポジトリ",
    searchRepositories: "リポジトリを検索",
    searchWork: "Issue とプルリクエストを検索",
    ...
    all: "すべて",
    archived: "アーカイブ済み",
    loadFailed: "GitHub の作業を読み込めません",
    openSource: "GitHub で開く",
    openFailed: "GitHub を開けません",
    updateAssignments: "割り当てを作成するにはホストを更新してください",
    invalidWorkItem: "この項目は作業項目として保存できません",
    noBody: "説明がありません",
    bodyTruncated: "プレビューは省略されています。説明の全文は GitHub で確認してください。",
    loadMore: "さらに読み込む",
    refresh: "更新",
  },
  ...
  teams: {
    ...
    title: "チーム",
    newTeam: "新しいチーム",
    selectTeam: "チームを選択して役割とワークフローを表示",
    noHosts: "チームを管理するにはホストを追加してください",
    emptyHost: "このホストにチームはありません",
    openTeam: "{{host}} の {{name}} を開く",
    roleStepCount: "役割 {{roles}} 件 · ステップ {{steps}} 件",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "接続中",
      loading: "読み込み中",
      ...
      offline: "オフライン",
      error: "エラー",
      unsupportedDetail: "チームを管理するには、このホストを更新してください。",
      profilesUnsupported:
        "エージェントプロファイルでチームを作成・編集するには、このホストを更新してください。",
      readOnlyOffline: "ホストがオンラインになるまで、このチームは読み取り専用です。",
    },
    actions: {
      ...en.teams.actions,
      create: "チームを作成",
      ...
      moveUp: "上へ移動",
      moveDown: "下へ移動",
      manageProfiles: "エージェントプロファイルを管理",
      retry: "再試行",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "チームの指示",
      roles: "役割",
      workflow: "ワークフロー",
      missingProfile: "エージェントプロファイルがありません",
      missingRole: "役割がありません",
      noStepInstructions: "ステップ固有の指示はありません",
    },
    runs: {
      ...en.teams.runs,
      form: {
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "監督対象のすべてのロールには、プロバイダー固有の委任を無効にしたエージェントプロファイルが必要です。",
        },
      },
      supervision: {
        ...
        title: "監督",
        supervisor: "監督者：{{name}}",
        progress: "作業項目 {{total}} 件中 {{completed}} 件が完了",
        needsReview: "レビューが必要",
        reviewRequest: "レビュー依頼",
        loadingRequest: "依頼の詳細を読み込み中…",
        updateRequired: "監督アクティビティの確認と応答には、このホストを更新してください。",
        offline: "監督の詳細を読み込むには、このホストに接続してください。",
        activity: "監督アクティビティ",
        emptyActivity: "監督アクティビティはまだ記録されていません。",
        status: {
          queued: "待機中",
          planning: "計画中",
          working: "作業中",
          awaiting_human: "レビュー待ち",
          completed: "完了",
          failed: "失敗",
          canceled: "キャンセル済み",
          interrupted: "中断済み",
        ...
        permission: {
          title: "プロバイダーの権限が必要です",
          detail: "{{role}} はエージェントのタイムラインで待機しています。",
          openAgent: "エージェントを開く",
        },
        references: {
          decision: "判断",
        ...
        response: {
          ...
          optionalNote: "メモ（任意）",
          submit: "応答を送信",
          conflict: "ホスト上で依頼が変更されました。最新の依頼を確認して再試行してください。",
          validation: {
            action_required: "アクションを選択してください。",
            action_unavailable: "選択したアクションは利用できなくなりました。",
            note_required: "このアクションにはメモが必要です。",
            note_too_long: "メモは 4,096 文字以内にしてください。",
            request_settled: "この依頼はすでに解決済みです。",
          },
        },
      },
    },
    form: {
      ...
      host: "ホスト",
      selectHost: "ホストを選択",
      noHosts: "利用可能なホストがありません",
      name: "名前",
      instructions: "チームの指示",
      roleName: "役割名",
      profile: "エージェントプロファイル",
      selectProfile: "エージェントプロファイルを選択",
      noProfiles: "エージェントプロファイルがありません",
      searchProfiles: "エージェントプロファイルを検索",
      roleInstructions: "役割の指示",
      workflowRole: "役割",
      selectRole: "役割を選択",
      noRoles: "役割がありません",
      unnamedRole: "名前のない役割",
      stepInstructions: "ステップの指示",
      optional: "任意",
    },
    delete: {
      title: "チームを削除しますか？",
      message: "{{name}} を削除しますか？過去のチーム実行は変更されません。",
    },
    errors: {
      load: "チームを読み込めませんでした",
      conflict:
        "ホスト上でこのチームが変更されました。エディターを閉じ、再読み込みしてから再試行してください。",
    },
  },
  operations: {
    title: "オペレーション",
    ...
    actions: {
      refresh: "更新",
      openAgent: "{{agent}}を開く",
      openWorkspace: "ワークスペース{{workspace}}を開く",
    },
    summary: {
      working: "作業中",
      attention: "要確認",
      idle: "待機中",
      accessibility: "作業中 {{working}}、要確認 {{attention}}、待機中 {{idle}}",
    },
    states: {
      running: "作業中",
      needs_input: "入力が必要",
    ...
    relationship: {
      ...
      missing: "親エージェント{{parent}}は利用できません",
      cycle: "親子関係が無効です",
    },
  },
  agentList: {
