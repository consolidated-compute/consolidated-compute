...
export const ko: TranslationResources = {
  ...
  githubWork: {
    ...
    selectHost: "호스트 선택",
    noHosts: "설정된 호스트 없음",
    hostOffline: "이 호스트의 연결을 기다리는 중",
    updateHost: "GitHub 작업을 탐색하려면 이 호스트를 업데이트하세요",
    site: "GitHub 호스트 이름",
    invalidSite: "URL이나 경로 없이 호스트 이름을 입력하세요",
    repositories: "저장소",
    searchRepositories: "저장소 검색",
    searchWork: "이슈 및 풀 리퀘스트 검색",
    selectRepository: "저장소 선택",
    noRepositories: "저장소를 찾을 수 없음",
    noWork: "일치하는 작업 없음",
    issues: "이슈",
    pullRequests: "풀 리퀘스트",
    open: "열림",
    ...
    all: "전체",
    archived: "보관됨",
    loadFailed: "GitHub 작업을 불러올 수 없음",
    openSource: "GitHub에서 열기",
    openFailed: "GitHub를 열 수 없음",
    updateAssignments: "할당을 만들려면 이 호스트를 업데이트하세요",
    invalidWorkItem: "이 항목은 작업 항목으로 저장할 수 없습니다",
    noBody: "설명 없음",
    bodyTruncated: "미리보기가 잘렸습니다. 전체 설명은 GitHub에서 확인하세요.",
    loadMore: "더 불러오기",
    refresh: "새로 고침",
  },
  ...
  teams: {
    ...
    title: "팀",
    newTeam: "새 팀",
    selectTeam: "팀을 선택하여 역할과 워크플로 보기",
    noHosts: "팀을 관리하려면 호스트를 추가하세요",
    emptyHost: "이 호스트에 팀이 없습니다",
    openTeam: "{{host}}에서 {{name}} 열기",
    roleStepCount: "역할 {{roles}}개 · 단계 {{steps}}개",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "연결 중",
      loading: "불러오는 중",
      ...
      offline: "오프라인",
      error: "오류",
      unsupportedDetail: "팀을 관리하려면 이 호스트를 업데이트해야 합니다.",
      profilesUnsupported: "에이전트 프로필로 팀을 만들거나 편집하려면 이 호스트를 업데이트하세요.",
      readOnlyOffline: "호스트가 온라인이 될 때까지 이 팀은 읽기 전용입니다.",
    },
    actions: {
      ...en.teams.actions,
      create: "팀 만들기",
      ...
      moveUp: "위로 이동",
      moveDown: "아래로 이동",
      manageProfiles: "에이전트 프로필 관리",
      retry: "다시 시도",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "팀 지침",
      roles: "역할",
      workflow: "워크플로",
      missingProfile: "에이전트 프로필 없음",
      missingRole: "역할 없음",
      noStepInstructions: "단계별 지침 없음",
    },
    runs: {
      ...en.teams.runs,
      form: {
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "감독되는 모든 역할은 공급자 기본 위임을 비활성화한 에이전트 프로필을 사용해야 합니다.",
        },
      },
      supervision: {
        ...
        title: "감독",
        supervisor: "감독자: {{name}}",
        progress: "작업 항목 {{total}}개 중 {{completed}}개 완료",
        needsReview: "검토 필요",
        reviewRequest: "검토 요청",
        loadingRequest: "요청 세부 정보 불러오는 중…",
        updateRequired: "감독 활동을 확인하고 응답하려면 이 호스트를 업데이트하세요.",
        offline: "감독 세부 정보를 불러오려면 이 호스트에 연결하세요.",
        activity: "감독 활동",
        emptyActivity: "아직 기록된 감독 활동이 없습니다.",
        status: {
          queued: "대기 중",
          planning: "계획 중",
          working: "작업 중",
          awaiting_human: "검토 대기 중",
          completed: "완료됨",
          failed: "실패",
          canceled: "취소됨",
          interrupted: "중단됨",
        ...
        permission: {
          title: "공급자 권한 필요",
          detail: "{{role}} 역할이 에이전트 타임라인에서 대기 중입니다.",
          openAgent: "에이전트 열기",
        },
        references: {
          decision: "결정",
        ...
        response: {
          ...
          note: "메모",
          optionalNote: "메모(선택 사항)",
          submit: "응답 제출",
          conflict: "호스트에서 이 요청이 변경되었습니다. 최신 요청을 검토하고 다시 시도하세요.",
          validation: {
            action_required: "작업을 선택하세요.",
            action_unavailable: "선택한 작업을 더 이상 사용할 수 없습니다.",
            note_required: "이 작업에는 메모가 필요합니다.",
            note_too_long: "메모는 4,096자 이하여야 합니다.",
            request_settled: "이 요청은 이미 해결되었습니다.",
          },
        },
      },
    },
    form: {
      ...
      roleName: "역할 이름",
      profile: "에이전트 프로필",
      selectProfile: "에이전트 프로필 선택",
      noProfiles: "에이전트 프로필 없음",
      searchProfiles: "에이전트 프로필 검색",
      roleInstructions: "역할 지침",
      workflowRole: "역할",
      selectRole: "역할 선택",
      noRoles: "역할 없음",
      unnamedRole: "이름 없는 역할",
      stepInstructions: "단계 지침",
      optional: "선택 사항",
    },
    delete: {
      title: "팀을 삭제할까요?",
      message: "{{name}}을(를) 삭제할까요? 이전 팀 실행은 변경되지 않습니다.",
    },
    errors: {
      load: "팀을 불러오지 못했습니다",
      conflict: "호스트에서 이 팀이 변경되었습니다. 편집기를 닫고 다시 불러온 후 재시도하세요.",
    },
  },
  operations: {
    title: "운영",
    ...
    untitledProviderSubagent: "제목 없는 공급자 하위 에이전트",
    providerSubagent: "공급자 하위 에이전트",
    otherWork: "기타 작업",
    ...
    actions: {
      refresh: "새로고침",
      openAgent: "{{agent}} 열기",
      openWorkspace: "워크스페이스 {{workspace}} 열기",
    },
    summary: {
      working: "작업 중",
      attention: "주의 필요",
      idle: "대기 중",
      accessibility: "작업 중 {{working}}, 주의 필요 {{attention}}, 대기 중 {{idle}}",
    },
    states: {
      running: "작업 중",
      needs_input: "입력 필요",
    ...
    availability: {
      ...
      providerSubagentsPartial: "일부 공급자 하위 에이전트 데이터를 사용할 수 없음",
      providerSubagentsUnsupported:
        "공급자 하위 에이전트를 표시하려면 {{host}} 호스트를 업데이트해야 합니다",
      providerSubagentsLastKnown:
        "{{host}}의 공급자 하위 에이전트를 새로 고칠 수 없어 마지막으로 확인된 데이터를 표시합니다",
      providerSubagentsUnavailable: "{{host}}의 공급자 하위 에이전트를 불러올 수 없습니다",
    },
    relationship: {
      crossWorkspace: "다른 워크스페이스에 있는 {{parent}}의 하위 에이전트",
      missing: "상위 에이전트 {{parent}}을(를) 사용할 수 없음",
      cycle: "잘못된 상위 관계",
    },
  },
  agentList: {
