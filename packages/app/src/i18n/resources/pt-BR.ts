...
export const ptBR: TranslationResources = {
  hostSecurity: hostSecurity["pt-BR"],
  common: {
    back: "Voltar",
    loading: "Carregando...",
    actions: {
  ...
  githubWork: {
    ...
    hostOffline: "Aguardando a conexão deste host",
    updateHost: "Atualize este host para explorar trabalho do GitHub",
    site: "Nome do host do GitHub",
    invalidSite: "Digite um nome de host sem URL ou caminho",
    repositories: "Repositórios",
    searchRepositories: "Buscar repositórios",
    searchWork: "Buscar issues e pull requests",
    selectRepository: "Selecione um repositório",
    noRepositories: "Nenhum repositório encontrado",
    noWork: "Nenhum trabalho correspondente",
    issues: "Issues",
    ...
    all: "Todos",
    archived: "Arquivado",
    loadFailed: "Não foi possível carregar o trabalho do GitHub",
    openSource: "Abrir no GitHub",
    openFailed: "Não foi possível abrir o GitHub",
    updateAssignments: "Atualize este host para criar atribuições",
    invalidWorkItem: "Este item não pode ser salvo como item de trabalho",
    noBody: "Sem descrição",
    bodyTruncated: "Prévia truncada. Abra o GitHub para ver a descrição completa.",
    loadMore: "Carregar mais",
    refresh: "Atualizar",
  },
  assignments: {
  ...
  teams: {
    ...
    title: "Equipes",
    newTeam: "Nova equipe",
    selectTeam: "Selecione uma equipe para ver suas funções e fluxo de trabalho",
    noHosts: "Adicione um host para gerenciar equipes",
    emptyHost: "Nenhuma equipe neste host",
    openTeam: "Abrir {{name}} em {{host}}",
    roleStepCount: "{{roles}} funções · {{steps}} etapas",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "Conectando",
      loading: "Carregando",
      ...
      offline: "Offline",
      error: "Erro",
      unsupportedDetail: "Este host precisa ser atualizado para gerenciar equipes.",
      profilesUnsupported: "Atualize este host para criar ou editar equipes com Perfis de Agente.",
      readOnlyOffline: "Esta equipe ficará somente leitura até o host voltar a ficar online.",
    },
    actions: {
      ...en.teams.actions,
      create: "Criar equipe",
      ...
      manageProfiles: "Gerenciar Perfis de Agente",
      retry: "Tentar novamente",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "Instruções da equipe",
      roles: "Funções",
      workflow: "Fluxo de trabalho",
      missingProfile: "Perfil de Agente ausente",
      missingRole: "Função ausente",
      noStepInstructions: "Sem instruções específicas para esta etapa",
    },
    runs: {
      ...en.teams.runs,
      actions: {
      ...
      form: {
        ...
        validation: {
          ...
          workspaces_loading: "Carregando espaços de trabalho.",
          supervisor_required: "Selecione uma função de supervisor.",
          supervisor_unavailable:
            "Esta equipe precisa de uma função fora do fluxo de trabalho para executar sob supervisão.",
          native_delegation_unenforced:
            "Cada função supervisionada deve usar um perfil de agente que desative a delegação nativa do provedor.",
        },
      },
      supervision: {
        ...
        progress: "{{completed}} de {{total}} itens de trabalho concluídos",
        needsReview: "Precisa de revisão",
        reviewRequest: "Solicitação de revisão",
        loadingRequest: "Carregando detalhes da solicitação…",
        updateRequired: "Atualize este host para consultar e responder à atividade de supervisão.",
        offline: "Conecte-se a este host para carregar os detalhes da supervisão.",
        activity: "Atividade de supervisão",
        emptyActivity: "Nenhuma atividade de supervisão foi registrada ainda.",
        status: {
          queued: "Na fila",
          planning: "Planejando",
        ...
        permission: {
          title: "Permissão do provedor necessária",
          detail: "{{role}} está aguardando na linha do tempo do agente.",
        ...
        response: {
          ...
          conflict:
            "Esta solicitação mudou no host. Revise a solicitação mais recente e tente novamente.",
          validation: {
            action_required: "Escolha uma ação.",
            action_unavailable: "A ação selecionada não está mais disponível.",
            note_required: "Esta ação exige uma observação.",
            note_too_long: "As observações devem ter no máximo 4.096 caracteres.",
            request_settled: "Esta solicitação já foi resolvida.",
          },
        },
      },
    },
    form: {
      ...
      name: "Nome",
      instructions: "Instruções da equipe",
      roleName: "Nome da função",
      profile: "Perfil de Agente",
      selectProfile: "Selecione um Perfil de Agente",
      noProfiles: "Nenhum Perfil de Agente",
      searchProfiles: "Buscar Perfis de Agente",
      roleInstructions: "Instruções da função",
      workflowRole: "Função",
      selectRole: "Selecione uma função",
      noRoles: "Nenhuma função",
      unnamedRole: "Função sem nome",
      stepInstructions: "Instruções da etapa",
      optional: "Opcional",
    },
    delete: {
      title: "Excluir equipe?",
      message: "Excluir {{name}}? As execuções históricas da equipe permanecerão inalteradas.",
    },
    errors: {
      load: "Não foi possível carregar as equipes",
      conflict: "Esta equipe mudou no host. Feche o editor, recarregue-a e tente novamente.",
    },
  },
  operations: {
    title: "Operações",
    ...
    untitledProviderSubagent: "Subagente do provedor sem título",
    providerSubagent: "Subagente do provedor",
    ...
    availability: {
      ...
      refreshFailed: "Não foi possível atualizar Operações",
      hostDataLastKnown:
        "Não foi possível atualizar os dados de {{host}}; exibindo os últimos dados conhecidos",
      hostDataUnavailable: "Não foi possível carregar os dados de {{host}}",
      ...
      providerSubagentsPartial: "Alguns dados de subagentes do provedor estão indisponíveis",
      providerSubagentsUnsupported:
        "{{host}} precisa ser atualizado para mostrar subagentes do provedor",
      providerSubagentsLastKnown:
        "Não foi possível atualizar os subagentes de {{host}}; mostrando os últimos dados conhecidos",
      providerSubagentsUnavailable: "Não foi possível carregar os subagentes de {{host}}",
    },
    relationship: {
