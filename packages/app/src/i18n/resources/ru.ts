...
export const ru: TranslationResources = {
  ...
  githubWork: {
    ...
    hostOffline: "Ожидание подключения этого хоста",
    updateHost: "Обновите хост для просмотра работы в GitHub",
    site: "Имя хоста GitHub",
    invalidSite: "Введите имя хоста без URL и пути",
    repositories: "Репозитории",
    searchRepositories: "Поиск репозиториев",
    searchWork: "Поиск задач и запросов на слияние",
    selectRepository: "Выберите репозиторий",
    noRepositories: "Репозитории не найдены",
    noWork: "Нет подходящей работы",
    issues: "Задачи",
    ...
    all: "Все",
    archived: "В архиве",
    loadFailed: "Не удалось загрузить работу из GitHub",
    openSource: "Открыть в GitHub",
    openFailed: "Не удалось открыть GitHub",
    updateAssignments: "Обновите хост для создания назначений",
    invalidWorkItem: "Этот элемент нельзя сохранить как рабочий элемент",
    noBody: "Нет описания",
    bodyTruncated: "Предпросмотр сокращён. Полное описание доступно в GitHub.",
    loadMore: "Загрузить ещё",
    refresh: "Обновить",
  },
  assignments: {
  ...
  teams: {
    ...
    selectTeam: "Выберите команду, чтобы просмотреть роли и рабочий процесс",
    noHosts: "Добавьте хост для управления командами",
    emptyHost: "На этом хосте нет команд",
    openTeam: "Открыть {{name}} на {{host}}",
    roleStepCount: "Ролей: {{roles}} · шагов: {{steps}}",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "Подключение",
      loading: "Загрузка",
      ready: "В сети",
      unsupported: "Требуется обновление",
      offline: "Не в сети",
      error: "Ошибка",
      unsupportedDetail: "Обновите этот хост, чтобы управлять командами.",
      profilesUnsupported:
        "Обновите этот хост, чтобы создавать и редактировать команды с профилями агентов.",
      readOnlyOffline: "Команда доступна только для чтения, пока хост не в сети.",
    },
    actions: {
      ...en.teams.actions,
      ...
      manageProfiles: "Управление профилями агентов",
      retry: "Повторить",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "Инструкции команды",
      roles: "Роли",
      workflow: "Рабочий процесс",
      missingProfile: "Профиль агента отсутствует",
      missingRole: "Роль отсутствует",
      noStepInstructions: "Нет инструкций для этого шага",
    },
    runs: {
      ...en.teams.runs,
      actions: {
      ...
      form: {
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "Каждая контролируемая роль должна использовать профиль агента с отключённым встроенным делегированием провайдера.",
        },
      },
      supervision: {
        ...en.teams.runs.supervision,
        title: "Наблюдение",
        supervisor: "Руководитель: {{name}}",
        progress: "Выполнено рабочих элементов: {{completed}} из {{total}}",
        needsReview: "Требуется проверка",
        reviewRequest: "Запрос на проверку",
        loadingRequest: "Загрузка сведений о запросе…",
        updateRequired:
          "Обновите этот хост, чтобы просматривать действия наблюдения и отвечать на них.",
        offline: "Подключитесь к этому хосту, чтобы загрузить сведения о наблюдении.",
        activity: "Действия наблюдения",
        emptyActivity: "Действия наблюдения ещё не зарегистрированы.",
        status: {
          queued: "В очереди",
          planning: "Планирование",
          working: "Выполняется",
          awaiting_human: "Ожидает проверки",
          completed: "Завершено",
          failed: "Ошибка",
          canceled: "Отменено",
        ...
        permission: {
          title: "Требуется разрешение провайдера",
          detail: "Роль {{role}} ожидает в журнале агента.",
        ...
        response: {
          ...
          conflict: "Запрос изменился на хосте. Проверьте последнюю версию и повторите попытку.",
          validation: {
            action_required: "Выберите действие.",
            action_unavailable: "Выбранное действие больше недоступно.",
            note_required: "Для этого действия требуется примечание.",
            note_too_long: "Примечание должно содержать не более 4 096 символов.",
            request_settled: "Этот запрос уже разрешён.",
          },
        },
      },
    },
    form: {
      ...
      name: "Название",
      instructions: "Инструкции команды",
      roleName: "Название роли",
      profile: "Профиль агента",
      selectProfile: "Выберите профиль агента",
      noProfiles: "Нет профилей агентов",
      searchProfiles: "Поиск профилей агентов",
      roleInstructions: "Инструкции роли",
      workflowRole: "Роль",
      selectRole: "Выберите роль",
      noRoles: "Нет ролей",
      unnamedRole: "Роль без названия",
      stepInstructions: "Инструкции шага",
      optional: "Необязательно",
    },
    delete: {
      title: "Удалить команду?",
      message: "Удалить {{name}}? История запусков команды не изменится.",
    },
    errors: {
      load: "Не удалось загрузить команды",
      conflict:
        "Команда была изменена на хосте. Закройте редактор, загрузите её заново и повторите попытку.",
    },
  },
  operations: {
    title: "Операции",
  ...
  settings: {
    ...
    host: {
      ...
      agentProfiles: {
        ...
        securityBoundaryLabel: "Граница безопасности",
        securityBoundaryPlaceholder: "Выберите границу безопасности провайдера",
        noSecurityBoundaries: "Этот провайдер не предлагает поддерживаемых границ безопасности",
        customSecurityBoundary: "Пользовательские нативные настройки",
        securityStates: {
          idle: "Выберите провайдера, чтобы увидеть поддерживаемые границы безопасности.",
          pending: "Проверка поддерживаемых провайдером границ безопасности…",
          available: "Эта граница предоставлена и проверена провайдером.",
          unrecognized:
            "В профиле есть пользовательские нативные настройки. Они сохранятся, пока вы не выберете поддерживаемую границу.",
          stale:
            "Элементы управления безопасностью провайдера изменились. Перед сохранением выберите границу заново.",
          read_only:
            "Существующие нативные настройки безопасности будут сохранены, но их нельзя изменить здесь.",
          unavailable:
            "Не удалось загрузить границы безопасности. Повторите получение снимка провайдера.",
          unsupported: "Провайдер не объявляет редактируемые границы безопасности.",
          update_required:
            "Обновите этот хост, прежде чем менять профиль с нативными настройками безопасности.",
        },
