...
export const zhCN: TranslationResources = {
  ...
  githubWork: {
    ...
    selectHost: "选择主机",
    noHosts: "尚未配置主机",
    hostOffline: "正在等待此主机连接",
    updateHost: "更新此主机以浏览 GitHub 工作",
    site: "GitHub 主机名",
    invalidSite: "请输入不含 URL 或路径的主机名",
    repositories: "仓库",
    searchRepositories: "搜索仓库",
    searchWork: "搜索议题和拉取请求",
    selectRepository: "选择仓库",
    noRepositories: "未找到仓库",
    noWork: "没有匹配的工作",
    issues: "议题",
    pullRequests: "拉取请求",
    open: "开放",
    ...
    all: "全部",
    archived: "已归档",
    loadFailed: "无法加载 GitHub 工作",
    openSource: "在 GitHub 中打开",
    openFailed: "无法打开 GitHub",
    updateAssignments: "更新此主机以创建任务",
    invalidWorkItem: "无法将此条目保存为工作项",
    noBody: "暂无描述",
    bodyTruncated: "预览已截断。请打开 GitHub 查看完整描述。",
    loadMore: "加载更多",
    refresh: "刷新",
  },
  ...
  teams: {
    ...
    title: "团队",
    newTeam: "新建团队",
    selectTeam: "选择一个团队以查看角色和工作流",
    noHosts: "添加主机以管理团队",
    emptyHost: "此主机上没有团队",
    openTeam: "在 {{host}} 上打开 {{name}}",
    roleStepCount: "{{roles}} 个角色 · {{steps}} 个步骤",
    hostStates: {
      ...en.teams.hostStates,
      connecting: "正在连接",
      loading: "正在加载",
      ...
      offline: "离线",
      error: "错误",
      unsupportedDetail: "此主机需要更新后才能管理团队。",
      profilesUnsupported: "请更新此主机，以使用智能体配置文件创建或编辑团队。",
      readOnlyOffline: "主机恢复在线前，此团队为只读状态。",
    },
    actions: {
      ...en.teams.actions,
      create: "创建团队",
      ...
      moveUp: "上移",
      moveDown: "下移",
      manageProfiles: "管理智能体配置文件",
      retry: "重试",
    },
    detail: {
      ...en.teams.detail,
      sharedInstructions: "团队指令",
      roles: "角色",
      workflow: "工作流",
      missingProfile: "智能体配置文件缺失",
      missingRole: "角色缺失",
      noStepInstructions: "没有步骤专属指令",
    },
    runs: {
      ...en.teams.runs,
      form: {
        ...
        validation: {
          ...
          native_delegation_unenforced:
            "每个受监督角色都必须使用已停用提供商原生委派的智能体配置文件。",
        },
      },
      supervision: {
        ...
        title: "监督",
        supervisor: "监督者：{{name}}",
        progress: "已完成 {{completed}}/{{total}} 个工作项",
        needsReview: "需要审核",
        reviewRequest: "审核请求",
        loadingRequest: "正在加载请求详情…",
        updateRequired: "请更新此主机以查看和响应监督活动。",
        offline: "请连接到此主机以加载监督详情。",
        activity: "监督活动",
        emptyActivity: "尚未记录任何监督活动。",
        status: {
          queued: "已排队",
          planning: "正在规划",
          working: "正在工作",
        ...
        response: {
          ...
          optionalNote: "备注（可选）",
          submit: "提交响应",
          conflict: "此请求已在主机上更改。请查看最新请求并重试。",
          validation: {
            action_required: "请选择操作。",
            action_unavailable: "所选操作已不可用。",
            note_required: "此操作需要备注。",
            note_too_long: "备注不得超过 4,096 个字符。",
            request_settled: "此请求已解决。",
          },
        },
      },
    },
    form: {
      ...
      roleName: "角色名称",
      profile: "智能体配置文件",
      selectProfile: "选择智能体配置文件",
      noProfiles: "没有智能体配置文件",
      searchProfiles: "搜索智能体配置文件",
      roleInstructions: "角色指令",
      workflowRole: "角色",
      selectRole: "选择角色",
      noRoles: "没有角色",
      unnamedRole: "未命名角色",
      stepInstructions: "步骤指令",
      optional: "可选",
    },
    delete: {
      title: "删除团队？",
      message: "删除 {{name}}？历史团队运行将保持不变。",
    },
    errors: {
      load: "无法加载团队",
      conflict: "此团队已在主机上更改。请关闭编辑器，重新加载后重试。",
    },
  },
  operations: {
    title: "运行中心",
    ...
    untitledProviderSubagent: "未命名的提供方子 Agent",
    providerSubagent: "提供方子 Agent",
    otherWork: "其他工作",
    ...
    availability: {
      ...
      providerSubagentsPartial: "部分提供方子 Agent 数据不可用",
      providerSubagentsUnsupported: "需要更新主机 {{host}} 才能显示提供方子 Agent",
      providerSubagentsLastKnown: "无法刷新 {{host}} 的提供方子 Agent；正在显示最后已知数据",
      providerSubagentsUnavailable: "无法加载 {{host}} 的提供方子 Agent",
    },
    relationship: {
  ...
  settings: {
    ...
    host: {
      ...
      agentProfiles: {
        ...
        securityBoundaryLabel: "安全边界",
        securityBoundaryPlaceholder: "选择 Provider 安全边界",
        noSecurityBoundaries: "此 Provider 没有受支持的安全边界",
        customSecurityBoundary: "自定义原生设置",
        securityStates: {
          idle: "选择 Provider 以查看其支持的安全边界。",
          pending: "正在检查 Provider 支持的安全边界…",
          available: "此边界由 Provider 提供并验证。",
          unrecognized: "此配置包含自定义原生设置。选择受支持的边界前，这些设置会保留。",
          stale: "Provider 的安全控制已更改。请在保存前重新选择边界。",
          read_only: "现有原生安全设置会保留，但无法在此处编辑。",
          unavailable: "无法加载安全边界。请重试 Provider 快照。",
          unsupported: "此 Provider 未提供可编辑的安全边界。",
          update_required: "更改包含原生安全设置的配置前，请更新此 Host。",
        },
